...
namespace Lab13Models.Controllers
{
    public class RegisterController : Controller
    {
        ...
        public RegisterController(Lab13ModelsContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("ID,FirstName,LastName,Age,Alias,Mutation")] StudentModel studentModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,FirstName,LastName,Age,Alias,Mutation")] StudentModel studentModel)
        {
